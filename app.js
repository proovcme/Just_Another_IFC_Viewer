 ...
 * Отсекает GUID, технические суффиксы, уровни и семейства Revit
 */
cleanSystemName(rawName) {
    ...
    if ((name.includes('+') || name.includes('-')) && 
        (name.includes('План') || name.includes('Этаж') || name.includes('Кровля') || name.includes('Земля') || name.includes('Уровень'))) {
        return null;
    }
